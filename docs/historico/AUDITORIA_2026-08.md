# Auditoría y roadmap de agosto de 2026 — CERRADO

> **Documento histórico. No gobierna nada.**
>
> Registra la auditoría de julio-agosto de 2026 y las 17 fases A1..F2 que se
> ejecutaron a partir de ella (migraciones 053-069), todas cerradas. Se conserva
> porque explica **por qué** el sistema quedó como quedó: cada fase trae el
> problema medido que la motivó y lo que se descartó.
>
> Lo vigente vive en otra parte:
>
> | Qué | Dónde |
> |---|---|
> | Restricciones R-I..R-IV y congelados | `AGENTS.md` |
> | Configuración real del entorno | `AGENTS.md` |
> | Estado actual del código | `db/actual/INDICE.md` |
> | Qué falta por hacer | `docs/ROADMAP.md` |
> | Cómo se trabaja | `docs/GUIA_TRABAJO.md` |
>
> **Aviso sobre el contenido**: el bloque "CONFIGURACIÓN TEMPORAL" de más abajo
> quedó desactualizado (decía `opencode.ai/zen/v1` y modelo `hy3-free`; la
> realidad al 2026-08-18 es `generativelanguage.googleapis.com/v1beta/openai` y
> `gemini-3.5-flash-lite`). Se corrigió en `AGENTS.md`, no acá: este archivo se
